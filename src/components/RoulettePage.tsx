    ...
    <div className="min-h-screen">
      ...
      <div className="bg-[#F3E7C8]/90 backdrop-blur-md border-b border-[#D8C290] sticky top-0 z-20">
        <div className="max-w-2xl mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div>
            <h1 className="text-base font-bold text-[#3B2A16]" style={{ fontFamily: "'Gowun Batang', serif" }}>오행 룰렛</h1>
            <p className="text-xs text-[#9A8155]">하루 한 번, 오행의 기운을 뽑아보세요</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-2xl mx-auto px-4 py-5 space-y-4">
        ...
        <div className="bg-gradient-to-br from-[#FBF4E2] via-[#F3E7C8] to-[#EAD9B0] rounded-3xl p-6 shadow-xl shadow-[#000]/40 border border-[#9A6A1225] relative overflow-hidden">
          ...
          <div className="relative z-10 text-center">
            <p className="text-[#9A8155] text-xs mb-2">오늘의 이벤트</p>
            <div className="flex justify-center mb-2">
              <IcRoulette size={48} className="text-[#9A6A12]" />
            </div>
            ...
            <p className="text-sm text-[#6E5836] leading-relaxed">
              칸마다 포인트가 달라요. 운이 좋으면 <span className="text-[#9A6A12] font-semibold">잭폿 +100P</span>까지!
            </p>
          </div>
        </div>

        {/* 룰렛 영역 */}
        <div className="bg-[#FBF4E2] rounded-3xl border border-[#D8C290] shadow-[0_2px_20px_rgba(201,150,42,0.10)] p-6 flex flex-col items-center">
          <div className="relative w-64 h-64 mb-6 drop-shadow-[0_8px_20px_rgba(0,0,0,0.55)]">
            ...
            <div
              ...
              style={{
                ...
                background: 'linear-gradient(180deg, #FCEAA6, #9A6A12)',
              ...
              <svg viewBox="0 0 200 200" className="w-full h-full">
                <defs>
                  ...
                  <linearGradient id="rim-gradient" x1="0%" y1="0%" x2="100%" y2="100%">
                    ...
                    <stop offset="50%" stopColor="#9A6A12" />
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              <div
                ...
                style={{
                  background: 'radial-gradient(circle at 35% 30%, #FCEAA6, #9A6A12 60%, #8A6C1F)',
          ...
          {result && !spinning ? (
            <div className="text-center w-full">
              ...
              <p className="text-xs text-[#A89167] mb-2">현재 보유 {points.balance.toLocaleString()}P</p>
              <p className="text-sm font-semibold text-[#9A8155]">내일 다시 도전해보세요!</p>
            </div>
          ) : spunToday ? (
            <div className="text-center">
              <p className="text-sm font-semibold text-[#9A8155]">오늘 룰렛을 모두 사용했어요</p>
            ...
            <button
              onClick={handleSpin}
              disabled={spinning}
              className="w-full py-4 bg-gradient-to-r from-[#9A6A12] to-[#B5841C] text-[#0D0A1A] font-bold rounded-2xl shadow-lg shadow-[#9A6A1230] active:scale-[0.98] transition-all disabled:opacity-60 flex items-center justify-center gap-1.5"
            >
        ...
        <div className="bg-[#FBF4E2] rounded-3xl border border-[#D8C290] p-5">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h2 className="text-sm font-bold text-[#3B2A16]">칸별 보상 가이드</h2>
          </div>
            ...
            {ROULETTE_SEGMENTS.map(seg => (
              <li key={seg.key} className="flex items-center justify-between text-sm">
                <div className="flex items-center gap-2">
                  ...
                  />
                  <span className="text-[#6E5836]">{seg.label}</span>
                </div>
                <div className="flex items-center gap-3">
                  <span className="text-[#9A8155] text-xs">{seg.weight}%</span>
                  <span className="text-[#9A6A12] font-semibold">+{seg.amount}P</span>
                </div>
              </li>
            ))}
          </ul>
          <p className="text-xs text-[#A89167] mt-3">하루에 한 번만 돌릴 수 있어요. 매일 자정 초기화돼요.</p>
        </div>

      </div>

      <div className="text-center pb-8 text-xs text-[#A89167]">오행 룰렛 — 매일 자정 초기화</div>
    </div>
  )
}
