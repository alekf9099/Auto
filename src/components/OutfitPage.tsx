        ...
        {step === 'form' && (
          <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button
                      ...
                      className={`py-2.5 rounded-xl text-sm font-semibold border transition-all ${
                        birth.gender === g
                          ...
                          : 'bg-[#1C1438] border-[#2A1F4A] text-[#7B6F9A] hover:border-[#E0528250]'
                      }`}
                    >
                      {g === 'male' ? '남성 🧑' : '여성 👩'}
                    </button>
                ...
                <div className="grid grid-cols-3 gap-2">
                  {(['year','month','day'] as const).map(f => (
                    <input
                      ...
                      className="bg-[#1C1438] border border-[#2A1F4A] rounded-xl px-3 py-2.5 text-sm text-[#F5EDD4] placeholder:text-[#4A4060] focus:outline-none focus:border-[#E05282] transition text-center"
                    />
                  ))}
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    placeholder="0~23시"
                    min={0} max={23}
                    className="w-full bg-[#1C1438] border border-[#2A1F4A] rounded-xl px-3 py-2.5 text-sm text-[#F5EDD4] placeholder:text-[#4A4060] focus:outline-none focus:border-[#E05282] transition text-center"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    min={0} max={59}
                    disabled={birth.hour === ''}
                    className="w-full bg-[#1C1438] border border-[#2A1F4A] rounded-xl px-3 py-2.5 text-sm text-[#F5EDD4] placeholder:text-[#4A4060] focus:outline-none focus:border-[#E05282] transition text-center disabled:opacity-40"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 justify-center">
              ...
              <p className="text-[10px] text-[#4A4060]">사주팔자 일간 오행 기반</p>
              <div className="h-px flex-1 bg-[#2A1F4A]"/>
            </div>
          </form>
        )}
              ...
              <div className="flex gap-3">
                {result.todayData.avoidColors.map(c => (
                  <div key={c.hex} className="flex items-center gap-2">
                    ...
                    <p className="text-xs text-[#7B6F9A]">{c.name}</p>
                  </div>
                ))}
              </div>
            </div>
